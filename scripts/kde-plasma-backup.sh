...
SHARE_FILES=("color-schemes" "knewstuff3" "kxmlgui5" "plasma" "aurorae" "themes" "wallpapers" "icons") 
CONFIG_FILES=("plasma*" "powerdevilrc" "startupconfig" "startupconfigkeys" "systemsettingsrc" "touchpadrc" "gtk-2.0" "gtk-3.0" "gtk-4.0" "alacritty", "latte")
OUTPUT_DIR="/tmp"
